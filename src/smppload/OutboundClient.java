...
public class OutboundClient extends Client {
	...
	private Integer enquireLinkPeriod = 30000;
	...
	public OutboundClient(JTextArea logWindow) {
	...
	protected synchronized void reconnect(Integer connectionFailedTimes) {
		...
		try {
			...
			logger.debug("", e);
                        logWindow.append("Unable to connect: " + e.getMessage() + " " + LoggingUtil.toString(getConfiguration())+"\n");
			scheduleReconnect();
